...
public class CheckboxListviewAdapter2 extends ArrayAdapter<CheckboxItem> {
    ...
    public CheckboxListviewAdapter2(Context context, int textViewResourceId, CheckboxItem[] objects) {
        ...
        checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkbox.isChecked()) {
                    CheckedArray.checkArrayBuilding[position] = true;
                } else {
                    CheckedArray.checkArrayBuilding[position] = false;
                }
            }
        });
